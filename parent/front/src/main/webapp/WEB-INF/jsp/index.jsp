...
<body>
	...
	<table width="70%" align="center">
		<tr>
			<td colspan=4><a
				href="${pageContext.request.contextPath}/toCart">查看购物车</a></td>
		</tr>
		...
		<c:forEach var="m" items="${page.list}">
			...
			<td><a href="${pageContext.request.contextPath}/toGoodsDesc/${m.uuid}">
					<table border="1">
						<tr>
							<td><img alt="" src="${pageContext.request.contextPath}/static/images/2.jpg" /></td>
							<td>${m.description }</td>
						</tr>
						<tr>
							<td>${m.name }</td>
